...
function BottomNavigation() {
    ...
    return (
        <div className='fixed right-0 bottom-0 left-0 flex lg:hidden justify-between p-2 bg-white border shadow-sm'>
            <Button
                type='button'
            ...
            <Button type='button' aria-label='btn-nav-cate' variant='ghost' size='icon' className='w-10 h-10' asChild>
                <Link href='/cart'>
